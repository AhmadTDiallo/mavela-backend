...
public record AuthLoginResponse(
        ...
        @Schema(
                description = "JWT access token for authenticated API requests. Treat this value as sensitive.",
                format = "JWT",
        ...
        @Schema(
                description = "Refresh token for obtaining a new token pair. Treat this value as sensitive.",
                accessMode = Schema.AccessMode.READ_ONLY
        )
        String refreshToken,
