...
@RestControllerAdvice(
        assignableTypes = CustomerUsernameController.class
)
public class CustomerUsernameExceptionHandler {

    @ExceptionHandler(CustomerUsernameException.class)
    public ResponseEntity<ProblemDetail> handleUsernameException(
            CustomerUsernameException exception,
        ...
        problem.setTitle("Username selection failed");
        problem.setInstance(
    ...
    public ResponseEntity<ProblemDetail> handleValidationException(
        ...
        problem.setTitle("Username request is invalid");
        problem.setInstance(
                URI.create(request.getRequestURI())
        );
        problem.setProperty(
